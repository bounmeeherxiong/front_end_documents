...
export const CreateForm = () => {
    ...
    const onCreateTable = () => {
        if (datatable.length == 0) {
            ...
            for (let i = 0; i < tableColumn; i++) {
                ...
                let data;
                if(row== 1){
                    data = [{ name: '', value: '1', cols: 1, rows: 1, width: 80, height: 50 }]
    ...
    const onAddNewItem = () => {
        setShowstyle(true)
        setDatalable([...datalable, { name: 'Text', positionX: 50, positionY: 100, width: 0, height: 0, font: '15px', fontWeight: '', type: 'lable' }])
    }
    ...
    return (
        <>
            <div style={{ width: '100%', backgroundColor: '#ebedef' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', position: 'fixed', top: 0, left: 10, right: 25, zIndex: 999, height: 50, backgroundColor: "#ebedef", width: "100%" }}>
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start' }}>
                        ...
                        <div style={{ borderRadius: 3, width: 50, marginLeft: 10, marginRight: 25, cursor: 'pointer', height: 30, marginTop: 10 }}
                ...
                <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ width: '50%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        {/* <div style={{ backgroundColor: 'white', width: 600, border: '1px solid #ccc', marginRight: 5 }}>
                        
                        <small style={{fontSize:20}}>Approval process</small>
                        <div style={{height:20}}>
